...
function Question() {
    ...
    return (
        <PaddingContainer>
            <Text sx={{ fontSize: [14, 32, 40], textAlign: "center", paddingBottom:["2%","2%","3%"], paddingTop:["2%","2%","0%"], color:"#403f3d"}}>
                <strong>Frequently Asked Questions</strong>
            </Text>

            <Box sx={{padding:["0 3%","0 6%","0 8%"]}}>
                    
            <Collapsible open={true} className='openclose-container' trigger="1. What is JomGift?" style={{color:"#403f3d"}}><i className="fas fa-minus" style={{float:"right"}}></i>
                        <Text sx={{fontSize:[12,24,28], color:"rgb(146,146,146)", paddingTop:["1%",null,"2%"], borderBottom:"1px solid rgb(196,196,196)", paddingBottom:["2%"]}}>
