...
function Support() {
    return (
        <PaddingContainer className="support-container">
            ...
            <Box sx={{marginY:["2%"]}}>
            <Text sx={{ fontSize: [14, 32, 40] ,textAlign: "center", color:"#403f3d"}}>
                <strong>Need Help? Looking For Support?</strong>
            </Text>
            
                        <Box sx={{ padding: ["0 3%", "0 5%", "0 8%"], textAlign: "center" }}>
                            <Text sx={{ fontSize: [12, 24, 32], margin:["2% 0"], paddingTop:["2%"], textAlign:"left"}}>We are always ready to help. Please fill the form below to send us a message or
                            ...
                            bg: "#FD9F13", borderRadius: "10px", fontSize:[14, 22, 26], marginTop:["3%"], border:[0], color:"#fff"
                            , cursor:'pointer'}}>
                                Submit
                            </Button>
